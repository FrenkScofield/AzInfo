...
$session_path = realpath(dirname(__FILE__).'/../../../../..').'/session.php';
...
class Securimage {
	...
	*/
	 ...
	 * @var string
	 */
	var $session_name = '_secureimage_php';
	...
	{		
		...
		$config_path = realpath($this->basepath.'/../../config').'/main.php';
		//die($config_path);
		
		require $config_path;
		$this->session_name = $_config['main']['session_name'];
