...
function CheckAuthentication()
{
	...
	return isset($_SESSION['mod_admin']['user']['user_id'])?true:false;
}
...
$pattern = $_app_dir.DS.'modules'.DS.'mod_admin'.DS.'assets'.DS.'js'.DS.'ckfinder'.DS.'core'.DS.'connector'.DS.'php';
$pattern = str_replace('/','\/',$pattern);

$base_url2 = trim(preg_replace('/('.$pattern.')$/','',$base_url2));
...
$baseUrl = BASE_URL2.'/'.$media_folder.'/';
$baseUrl_wots = BASE_URL2.'/'.$media_folder;
//echo $baseUrl; die();
/*
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = BASE_PATH.'/'.$media_folder.'/';
$baseDir_wots = BASE_PATH.'/'.$media_folder;
//echo $baseDir; die();
/*
 * ### Advanced Settings
 */
